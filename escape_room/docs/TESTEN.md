...
##### Tabel
| # | Actie (automatisch)                                                   | Verwachte uitkomst                           | Echte uitkomst                               | Resultaat |
|---|-----------------------------------------------------------------------|----------------------------------------------|----------------------------------------------|-----------|
...
##### Uitleg
Als er nog geen knop is gedrukt, of dit al een paar seconden niet is gebeurt, wordt automatisch de kleuren sequentie in een oneindige loop laten zien. Tussen de kleuren is een korte pauze. Na de sequentie is een langere pauze.
...
|---|---------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|-----------|
| 1 | Kijk naar de kleuren van de LED                         | Dezelfde 3 kleuren worden steeds opnieuw een voor een laten zien                                             | Dezelfde kleuren worden steeds opnieuw een voor een laten zien                                              | Goed      |
| 2 | Druk de bijbehorende knoppen in. In dezelfde volgorde.  | De LED heeft kort een groen licht. Daarna begint dezelfde kleuren sequentie met 1 kleur meer aan het einde.  | De LED heeft kort een groen licht. Daarna begint dezelfde kleren sequentie met 1 kleur meer aan het einde.  | Goed      |
...
| # | Actie                                                                                           | Verwachte uitkomst                                                                | Echte uitkomst                                                                    | Resultaat |
|---|-------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|-----------|
| 1 | Kijk naar de kleuren van de LED                                                                 | Dezelfde 4 kleuren worden steeds opnieuw een voor een laten zien                  | Dezelfde 4 kleuren worden steeds opnieuw een voor een laten zien                  | Goed      |
...
| 1 | Druk bij de LED & Key twee keer op knop 5                                                  | De LED's links boven gaan uit                             | De LED's links boven gaan uit                             | Goed      |
...
| 1 | Bij de challenge Reaction Time, druk de knop als een van de rode LED's brand               | De rode LED knippert een paar keer                        | De rode LED knippert een paar keer                        | Goed      |
...
| 3 | Druk bij de LED & Key vijf keer op knop 8                                                  | De LED's rechts boven gaan uit en je hoort een korte piep | De LED's rechts boven gaan uit en je hoort een korte piep | Goed      |

##### Uitleg
We testen hier of de challenges afzonderlijk en asynchroon werken. Met de eerste 4 stappen worden de challenges op een half afgemaakte stand gezet. Stap 2 en 3 testen of alles nog werkt zoals verwacht.
...
##### Uitleg
De melodie laat de gebruiker weten dat hij/ze heeft gewonnen. Voor de zekerheid worden alle challenges uit gezet bij het winnen. Stap 4 test dit.
...
##### Uitleg
De piepen laten de gebruiker weten dat hij/ze heeft verloren. Voor de zekerheid worden alle challenges uit gezet bij een timeout. Stap 4 test dit.
...
Het is niet mogelijk om vals te spelen zonder de draden aan te raken. Bij het 5+ keer halen en 3 keer verliezen van de laatste versie van de escape room heb ik geen problemen gevonden. Vrienden en familie hebben ook niets gevonden.
